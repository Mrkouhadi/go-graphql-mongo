...
type ComplexityRoot struct {
	...
	DeleteBookResponse struct {
		DeleteBookID func(childComplexity int) int
	}
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "deleteBookResponse.deleteBookID":
		if e.complexity.DeleteBookResponse.DeleteBookID == nil {
			break
		}

		return e.complexity.DeleteBookResponse.DeleteBookID(childComplexity), true
...
func (ec *executionContext) fieldContext_Book__id(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) fieldContext_Mutation_deleteBook(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "deleteBookID":
				return ec.fieldContext_deleteBookResponse_deleteBookID(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type deleteBookResponse", field.Name)
		},
	}
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _deleteBookResponse_deleteBookID(ctx context.Context, field graphql.CollectedField, obj *model.DeleteBookResponse) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_deleteBookResponse_deleteBookID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_deleteBookResponse_deleteBookID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
...
func (ec *executionContext) unmarshalInputcreateBookInput(ctx context.Context, obj interface{}) (model.CreateBookInput, error) {
	...
	fieldsInOrder := [...]string{"TITLE", "AUTHOR", "PRICE"}
...
var deleteBookResponseImplementors = []string{"deleteBookResponse"}

func (ec *executionContext) _deleteBookResponse(ctx context.Context, sel ast.SelectionSet, obj *model.DeleteBookResponse) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, deleteBookResponseImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("deleteBookResponse")
		case "deleteBookID":
			out.Values[i] = ec._deleteBookResponse_deleteBookID(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalOdeleteBookResponse2ᚖgoᚑgqlᚑmongoᚋgraphᚋmodelᚐDeleteBookResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteBookResponse) graphql.Marshaler {
	...
	return ec._deleteBookResponse(ctx, sel, v)
}
